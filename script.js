...
//     if (user) {
//         showValue.textContent = `Logged in as: ${user.email}`;
//         loadQuotes();
//     } else {
...
//         return;
//     }
//     await addDoc(quoteCollection, { quote: text, time: serverTimestamp() });
//     quoteInput.value = "";
//     loadQuotes();
// }
...
//             const newText = prompt("Edit your quote:", docSnap.data().quote);
//             if (newText?.trim()) {
//                 await updateDoc(doc(db, "quotes", docSnap.id), { quote: newText.trim() });
//                 loadQuotes();
//             }
//         });
